...
$('#head')[0].innerHTML =
    '<div class="container">'
        ...
        + '<a href="https://github.com/ecomfe/echarts" target="_blank">'
            + '<img id="fork-image" style="position:absolute;top:0;right:0;border:0;z-index:1000;width:' + forkWidth + 'px" src="../img/fork.png" alt="Fork me on GitHub">'
        + '</a>'
         ...
         '<div class="container">'
            + '<div class="row" style="padding-bottom:20px;">'
                ...
                + '<div class="col-md-3 flogo">'
                    + '<a href="javascript:void(0)" onclick="back2Top()" title="' + (enVersion ? 'Back to top' : '回到顶部') + '"><img src="../img/echarts-logo2.png" alt="ECharts"/></a>'
                + '</div>'
            + '</div>'
